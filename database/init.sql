...
INSERT INTO apps (owner_id, name, initials, color, url, category, stage, description, request, views, credits) VALUES
    ...
    (1, 'Pricewise',    'P', '#0ea5e9', 'pricewise.io',     'SaaS Tools',      'Pre-launch', 'Pricing page A/B testing for indie SaaS founders. No code required — just drop in a script tag and start testing in minutes.',                                        'Looking for feedback on the landing page clarity — does the value proposition make sense immediately? Does the setup flow feel simple enough for a non-technical founder?',                                              890,  3),
    (1, 'CalPal',       'C', '#10b981', 'calpal.co',        'Productivity',    'Live',       'Smart scheduling for freelancers. Set your rules, share your link, and let clients book without the back-and-forth emails.',                                           'Please focus on the booking page experience — is it clear what''s being booked and when? Also any thoughts on mobile usability would be really helpful.',                                                                3210, 1),
    (1, 'Shiplog',      'S', '#f59e0b', 'shiplog.dev',      'Developer Tools', 'Beta',       'Changelog and release notes tool for indie developers. Beautiful public pages, email digests, and one-click embeds for your site.',                                    'Keen to hear whether the public changelog page design feels professional enough to share with customers. Does the email digest format feel readable? Any friction in the embed setup?',                                   2100, 2),
